    ...
    <>
      ...
      <main className="page-shell">
        <div className="detail-layout">
          <Image className="detail-image" src={dish.image} alt={dish.name} width={1000} height={1000} priority />
          <div className="detail-copy">
            <div className="eyebrow">{dish.category} · {dish.prepTime}</div>
            <h1>{dish.name}</h1>
            <div className="dish-meta">
              <span className="detail-price">${dish.price}</span>
              <span className="rating">★ {dish.rating} · {dish.reviewCount} reviews</span>
            </div>
            ...
            <div className="cook-meta">
              ...
              <div>
                ...
                <br />
                <Link className="text-link" href={`/cook/${cook?.slug}`}>{cook?.name} →</Link>
              </div>
            </div>
            <div className="hero-actions" style={{ marginTop: 30 }}>
              <button className="button button-primary" type="button">Request this dish</button>
        ...
        <section className="story">
          ...
          <p>This dish is prepared in small batches and made available on the day shown above. Message the cook with questions about ingredients, pickup, or the next menu.</p>
        </section>
      </main>
    </>
  );
